...
export const sendConnectionRequest = async (req, res) => {
    try {
        ...
        if(!connection){
            ...
            return res.json({success: false, message: 'Your are already connected with this user'})
        }
...
export const getUserConnections = async (req, res) => {
    try {
        const {userId} = req.auth()
        const user = await User.findById(userId).populate('connections followers followind')
